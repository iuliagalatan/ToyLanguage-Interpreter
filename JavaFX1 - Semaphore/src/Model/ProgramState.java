...
public class ProgramState {
    ...
    private IMyDictionary<Integer, Pair<Integer, List<Integer>>> semaphoreTable;
    private Integer id;
    static Integer count = 2;
    private Integer locklocation =0;
    ...
    public IMyDictionary<Integer, Pair<Integer, List<Integer>>> getSemaphoreTable() {
        return semaphoreTable;
    }

    public void setSemaphoreTable(IMyDictionary<Integer, Pair<Integer, List<Integer>>> semaphoreTable) {
        this.semaphoreTable = semaphoreTable;
    }

    public ProgramState(IMyStack<IStatement> stack, IMyDictionary<String, Value> symtable, IMyList<Value> list, IStatement orgPrg, IMyDictionary<StringValue,  BufferedReader> ft, IMyHeap<Integer, Value>heap, Integer id, IMyDictionary<Integer, Pair< Integer, List<Integer>>> semaphoreTable) throws CloneNotSupportedException {
