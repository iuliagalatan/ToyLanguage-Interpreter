...
public class ControllerGUI implements Initializable {
   ...
   @FXML private TableColumn exerciseColumn;
    ...
    private  TextMenu intialiseTableView() {
        ...
        IStatement exBarrier =new CompoundStatement(new VariableDeclarationStatement("v1", new RefType(new IntType())) ,
                new CompoundStatement(new VariableDeclarationStatement("v2", new RefType(new IntType())) ,
                        new CompoundStatement(new VariableDeclarationStatement("v3", new RefType(new IntType())) ,new CompoundStatement(new VariableDeclarationStatement("cnt", new IntType()) ,new CompoundStatement(new NewStatement("v1", new ConstantExpression(new IntValue(2))),
                                new CompoundStatement(new NewStatement("v2", new ConstantExpression(new IntValue(3))),
                                        new CompoundStatement(new NewStatement("v3", new ConstantExpression(new IntValue(4))),
                                                new CompoundStatement(new NewBarrierStatement("cnt", new ReadHeapExpression(new VariableExpression("v2"))),
                                                        new CompoundStatement(
                                                                new ForkStatement(
                                                                        new CompoundStatement(new AwaitBarrierStatement("cnt"),
                                                                                new CompoundStatement(new WriteHeapStatement("v1", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)), '*')),
                                                                                        new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")))))),
                                                                new CompoundStatement(
                                                                        new ForkStatement(new CompoundStatement(new AwaitBarrierStatement("cnt"),
                                                                                new CompoundStatement(new WriteHeapStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), new ConstantExpression(new IntValue(10)), '*')),
                                                                                        new CompoundStatement(  new WriteHeapStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), new ConstantExpression(new IntValue(10)), '*'))  ,
        ...
        if (TypeChecker(exBarrier)) {System.out.println("nu merge typecheck for barrier"); return null;}
        List<ProgramState> prg16 = new ArrayList<>();
        prg16.add(new ProgramState(exBarrier));
        ...
        menu.addCommand(new RunCommand("16", exBarrier.toString(), ctrl16));
