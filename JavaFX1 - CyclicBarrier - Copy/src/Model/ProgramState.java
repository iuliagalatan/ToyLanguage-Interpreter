...
public class ProgramState {
    ...
    public void setBarrierTable(IBarrierTable<Integer, Pair<Integer, List<Integer>>> barrierTable) {
        this.barrierTable = barrierTable;
    }

    public ProgramState(IMyStack<IStatement> stack, IMyDictionary<String, Value> symtable, IMyList<Value> list, IStatement orgPrg, IMyDictionary<StringValue,  BufferedReader> ft, IMyHeap<Integer, Value>heap, Integer id, IBarrierTable<Integer, Pair<Integer, List<Integer>>> barrierTable) throws CloneNotSupportedException {
