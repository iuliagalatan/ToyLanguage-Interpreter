...
public class ControllerGUI implements Initializable {
   ...
   @FXML private TableColumn exerciseColumn;
    ...
    private  TextMenu intialiseTableView() {
        ...
        IStatement exLock = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new NewStatement("v1", new ConstantExpression(new IntValue(20))),
                                                new CompoundStatement(
                                                        new NewStatement("v2", new ConstantExpression(new IntValue(30))),
                                                        new CompoundStatement(
        ...
        if (TypeChecker(exLock)) {System.out.println("nu merge typecheck for"); return null;}
        List<ProgramState> prg16 = new ArrayList<>();
        prg16.add(new ProgramState(exLock));
        ...
        menu.addCommand(new RunCommand("16", exLock.toString(), ctrl16));
