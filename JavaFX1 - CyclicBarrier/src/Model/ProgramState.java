...
public class ProgramState {
    ...
    private IMyDictionary<Integer, Pair<Integer, List<Integer>>> barrierTable;
    private Integer id;
    ...
    public IMyDictionary<Integer, Pair<Integer, List<Integer>>> getBarrierTable() {
        return barrierTable;
    }

    public void setBarrierTable(IMyDictionary<Integer, Pair<Integer, List<Integer>>> barrierTable) {
        this.barrierTable = barrierTable;
    }

    public ProgramState(IMyStack<IStatement> stack, IMyDictionary<String, Value> symtable, IMyList<Value> list, IStatement orgPrg, IMyDictionary<StringValue,  BufferedReader> ft, IMyHeap<Integer, Value>heap, Integer id, IMyDictionary<Integer, Pair<Integer, List<Integer>>> barrierTable) throws CloneNotSupportedException {
